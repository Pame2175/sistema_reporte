	...
	<section id="container">
		<h1>Lista de usuarios</h1>
		  ...
		  <button type="button" class="btn btn-success efecto " data-toggle="modal" data-target="#datos_personales_usuario" title="Datos personales">Agregar</button>
		  <!-- Modal -->
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
         ...
         <?php include "registrar_admin.php";?>
      </div>
 	...
 	<div class="tabla" style="margin:0 auto;text-align:center;">
		...
		if($fetch['estado']==1){
		echo'<p>
		<a href="estado_usuario.php?usuario_id='.$fetch['usuario_id'].'&estado=2"  style="background: green; color:white ; text-decoration:none;" >Activado</a></p>';
		}else
		{
		echo'<p><a href="estado_usuario.php?usuario_id='.$fetch['usuario_id'].'&estado=1" style="background: red; color:white;text-decoration:none;">Desactivado</a></p>';
