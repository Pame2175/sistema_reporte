    ...
    $query = mysqli_query($conection, "SELECT * FROM usuarios where usuario_cod= '$usuario_cod'");
    ...
    if($result > 0) 
    {
     echo'<script>
        ...
        confirmButtonText:"Ok"
          ...
          window.location="listas_usuarios.php";
          });
        </script>';
    }
    ...
    $query_insert = mysqli_query($conection, "INSERT INTO usuarios(usuario_cod,unique_id,nombre_usu,apellido,correo,clave,clavev,id_rol,estado) values ('$usuario_cod', '$rango_numerico', '$nombre', '$apellido', '$correo', '$clave', '$clavev', '1', '1')");
    if ($query_insert) 
    {
...
<head>
    ...
    <link rel="stylesheet" href="css/registrar_admin.css">
</head>

   
        <form action="listas_usuarios.php" method="POST" class="formulario" id="formulario">
            <!-- Grupo: Usuario -->
    ...
    <script type="text/javascript" src="js/registrar_admin.js"></script>
